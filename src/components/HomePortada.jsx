  ...
  return (
    <>     
        <div className='d-flex  justify-content-center mt-5 mb-5 pt-4 portada-container'>
                <div className='pt-5'>
                    <p>APART HOTEL & CABAÑAS PUERTO ESMERALDA</p>
                ...
                <div className='d-flex justify-content-center descripcion-container'>
                    ...
                    <p>Puerto Esmeralda contiene la bifurcación sur del río Esmeralda, un importante afluente de Idaho que crea un lugar espectacular para la pesca con mosca. Con sus aguas cristalinas de montaña y sus diversas especies de peces, entre las que se incluyen la trucha degollada, la trucha arcoíris, la trucha blanca y la trucha marrón, Puerto Escondido ofrece una experiencia de pesca inolvidable.</p>
